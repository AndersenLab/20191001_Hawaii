...
collection_counts <- tibble(`total number of distinct collections`,
                                ...
                                `collections with duplicated ids`) %>%
  
  
  column_to_rownames(., loc = 1)
  
colnames(collection_counts)
rownames(collection_counts)


col


`collection fraction with no worms`
`collection fraction with tracks only`
`collection fraction with nematodes`
`collections with location method 'photo'`
`collections with location method 'fulcrum'`
`collection fraction with loc method 'photo'`
`collection fraction with loc method 'fulcrum'`
`collections with altitude method 'geonames'`
`collections with altitude method 'fulcrum'`
`collection fraction with altitude method 'geonames'`
`collection fraction with altitude method 'fulcrum'`



```

### Collection overview plot
